...
void Foam::ThermalBubbleParcel<ParcelType>::setCellValues
(
...
template<class ParcelType>
template<class TrackCloudType>
void Foam::ThermalBubbleParcel<ParcelType>::calc
(
    TrackCloudType& cloud,
    trackingData& td,
    const scalar dt
...
template<class ParcelType>
template<class TrackCloudType>
Foam::scalar Foam::ThermalBubbleParcel<ParcelType>::calcHeatTransfer
(
    TrackCloudType& cloud,
    trackingData& td,
    const scalar dt,
...
#include "ThermalBubbleParcelIO.C"
